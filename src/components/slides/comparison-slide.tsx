    ...
    <SlideSurface>
      ...
      <SlideBody>
        ...
        >
          ...
          <div className="flex items-end pb-[0.7cqw] pr-[0.6cqw]">
          ...
          {options.map((option, i) => (
            <div
              ...
              className={cn(
                ...
                option.recommended ? cn(accent.fill, accent.onFill) : "bg-slide-wash text-slide-ink"
              )}
            >
              <span className="text-[1.4cqw] leading-[1.2] font-semibold">{option.name}</span>
              {option.recommended ? (
