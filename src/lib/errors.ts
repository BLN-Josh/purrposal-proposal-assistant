...
export const ERROR_DEFINITIONS = {
  ...
  INVALID_RESPONSE:
    "The AI returned something unexpected. Please retry the request.",
  TRUNCATED:
    "The answer ran past the length limit. Ask for something shorter, or retry.",
...
export function classifyError(err: unknown): {
  ...
  if (err instanceof Error) {
    ...
    if (/did not return structured output/.test(err.message))
      return entry("INVALID_RESPONSE");
